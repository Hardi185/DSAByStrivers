...
|-------------------------|---------------------|----------------------|-----------------------------------------------------------------------------------------------------------|
| **Approach 1: Brute Force** | O(n)                | O(n)                 | - Each node is stored in a HashMap, requiring O(1) lookup time.<br> - Traverses the entire linked list (O(n)).<br> - Space complexity is O(n) due to storing all nodes in the hash table in the worst case. |
